...
// T�ll� versio stringill� erotellaan eri versioita k�ytt�v�t shared_memory:t (voi olla eri SmartMet versioita rinnan k�yt�ss�), 
// eli jos task_structure, work_result_structure tai jokin merkitt�v� rakenne muuttuu, kasvata numeroa.
...
const std::string killer_task_name = "CRASH#&@'N'BURN"; // t�m�n niminen teht�v� aiheuttaa workerin �killisen kuoleman
...
typedef boost::interprocess::vector<float, float_allocator_type> shared_memory_vector;
    ...
    shared_memory_string relative_area_string_; // tuloshilan relatiivinen alue stringin�, muotoa: left,top,right,bottom
    ...
    shared_memory_vector z_values_; // hilattavien pisteiden arvot eli ns. 'korkeuskentt�'
    shared_memory_string smartmet_guid_; // ty�n antaneen smartmet instanssin guid
};
...
public:
    // Master process k�ytt�� t�t� (open or create)
    ...
    // Worker processit k�ytt�� t�t� (open only)
...
private:
    ...
    int& command_; // T�m� tulee Masterilta workerille: 0=ei alustettu, 1=tee ty�t�, 2=lopeta prosessi
    int& counter_; // Worker kasvattaa t�t� counteria esim. sekunnin v�lein, jos luku muuttuu, t�m� kertoo Masterille ett� worker on viel� elossa
    int& task_counter_; // Worker kasvattaa t�t� counteria kun se on saanut teht�v�n, t�m�n avulla Master voi p��tell� onko kukaan workereist� tehnyt mit��n tiettyyn aikaan ja jos ei ole ollut tekemist�, se voi lopettaa kaiken toiminnan
