...
static void InitCustomColorTableWithTransparentColor(NFmiIsoLineData &theIsoLineData, int theColorTableIndex, int theTransparencyColorIndex)
{
    ...
    std::vector<float> &origContourClasses = theIsoLineData.itsCustomColorContours; // t‰ss‰ on tallessa k‰ytetyt luokat
    ...
    std::vector<int> finalColorIndexTable; // t‰m‰ ratkaisee muidenkin taulukoiden koon, ei talleteta duplikaatteja tauluun
