...
protected:
   ...
   // Toivottavasti my�hemmin voidaan siivota yleisesti piirtokoodeja kun S-B-D on jo t�ysin k�yt�ss�.
...
protected:
   ...
   // datan oikean paikan my�s ns. laiva tms havaintojen yhteydess�.
   ...
   // eri karttan�ytt�luokissa (paitsi NFmiIsolineView-luokka on poikkeus) voi olla harvennus 
   ...
   // normaaleista synop datoista l�ydy arvoja, haetaan ne q2serverilt� sitten 
   // jos se on sallittu.
   // ************************************************************************
   ...
   bool fGetCurrentDataFromQ2Server; // kun dataa piirret��n, pit�� olla jokin dataInfo k�yt�ss�. Jos haetaan dataa, joka on tarpeeksi kaukana menneisyydess�, 
   ...
   // MacroParam laskuissa saattaa olla k�yt�ss� calculationpoint:eja. 
