        ...
        if(ctrlViewDocumentInterface->DrawLandBorders(mapViewDescTopIndex, separateBorderLayerDrawOptions))
        {
            ...
            if(ctrlViewDocumentInterface->BorderDrawPolylinesGdiplusDirty(mapViewDescTopIndex))
            {
                ...
                if(usedPath)
                {
                    ...
                    // laitetaan piirtovalmis polylinelista talteen dokumenttiin, t�m� my�s asettaa listaan liittyv�n likaisuus lipun pois eli k�ytt�valmiiksi
            ...
            if(borderPolyLineList.empty() == false)
            {
                ...
                // Pit�� luoda rajaviiva piirrossa k�yt�ss� olevan toolboxin avulla uusi Gdiplus-graphics olio, ei saa k�ytt�� mapView:in vastaavaa oliota!
            ...
            if(ctrlViewDocumentInterface->DrawLandBorders(mapViewDescTopIndex, separateBorderLayerDrawOptions))
            {
                ...
                if(ctrlViewDocumentInterface->BorderDrawPolylinesDirty(mapViewDescTopIndex))
                {
                    ...
                    if(usedPath)
                    {
                        ...
                        // laitetaan piirtovalmis polylinelista talteen dokumenttiin, t�m� my�s asettaa polyline-listaan liittyv�n dirty-flagin pois p��lt�
