...
// Sen takia pit�� antaa jokin aikaraja, jonka sis�ll� tietty kuva sallitaan piirrett�v�ksi karttan�yt�lle.
...
NFmiImageHolder NFmiSatelView::GetImageFromCache()
{
    ...
    {
        // Nyt ollaan Beta-tuotannossa, t�ll�in pit�� kuvien latausta odottaa loppuun asti loopissa eli kunnes ei olla en�� loading-moodissa
