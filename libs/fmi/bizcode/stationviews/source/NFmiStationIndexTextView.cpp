...
void NFmiStationIndexTextView::Draw(NFmiToolBox *theGTB)
{
    ...
    // Tarkistetaan my�s itsInfo pointer, koska kaatumisraportit vihjaisivat ett� SmartMet on kaatunut itsInfo->Param(itsParamId) -kutsuun
...
// Kun k�ytet��n synop-fonttia ja siihen liittyvi� symboleja, t�rm�sin ongelmaan Cl parametrin kanssa kun cloud type on 4, t�ll�in
...
double NFmiImageBasedSymbolView::CalcSymbolSizeInMM() const
{
    ...
    // T�ss� viel� viimeisi� ep�toivoisia symboli koko s��t�j� erilaisille karttaruudukko (columns x rows) tyypeille.
    // Yritin tehd� pikkuisia hienos��t�j� ett� aiemmin tehdyt muutokset CurrentDataRect-laskuissa eiv�t olisi liian 
