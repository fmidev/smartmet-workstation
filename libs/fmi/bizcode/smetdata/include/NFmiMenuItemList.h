...
// 
//  Change Log: 
// Changed 1999.08.24/Marko	Lis‰sin parit konstruktorit, jotka lis‰‰v‰t 
//							parametrimenuun myˆs eri levelit.
// 
//**********************************************************
...
class NFmiMenuItemList 
{
 public:
	...
	NFmiMenuItemList(int theMapViewDescTopIndex, NFmiParamBag* theParamBag, const FmiMenuCommandType &theMenuCommandType,
						const NFmiMetEditorTypes::View &theViewType, NFmiLevelBag* theLevels, NFmiInfoData::Type theDataType, FmiParameterName notLevelParam = kFmiLastParameter, const std::vector<std::unique_ptr<NFmiDataIdent>> *possibleMetaParams = nullptr);
