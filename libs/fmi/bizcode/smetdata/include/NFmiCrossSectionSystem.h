...
#include "NFmiPoint.h"
#include "NFmiDataMatrix.h" // täältä tulee checkedVector-luokka
...
class NFmiCrossSectionSystem
{
 ...
 private:
	...
	checkedVector<NFmiPoint> itsMainXYPoints; // pää pisteiden xy pisteet, joiden avulla piirretään väri-pallot CrossSectionManagerView:in footeriin (viimeksi piirretty CrossSectionView päivittää pisteet)
	checkedVector<NFmiPoint> itsMinorPoints; // pääpisteiden avulla lasketut välipisteet
	checkedVector<NFmiMetTime> itsRouteTimes; // reitin alku ja loppu ajan ja paikkojen avulla lasketut välipiste ajat (minuutin tarkkuudella)
	...
	checkedVector<ExtraRowInfo> itsExtraRowInfos; // tähä talletetaan ylimääräiset poikkileikkausrivi kohtaiset tiedot
