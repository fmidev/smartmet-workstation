...
{
public:
	static const NFmiPoint gMissingGridPoint; // T�t� missing grid-pistett� (-1, -1) voi k�ytt��, jos haluaa ilmaista ett� jokin grid-piste ei mahdollisesti ole initialisoitu
...
private:
	...
	NFmiMetTime itsMissTime; // n�it� eri aikoja tarvitaan oikeastaan vasta kun statistiikkaa kumuloidaan
	NFmiMetTime itsMinTime;
	NFmiMetTime itsMaxTime;
	NFmiParam itsParam;
	size_t itsLocationCheckingStep; // kuinka monen hilapisteen yli hyp�t��n tarkastuksissa, jos 0, tarkastetaan kaikki (nopeuttaa, jos ei tarkasteta kaikkia pisteit�)
	...
	float itsMaxValue;
	bool fChecksDone;
	bool fParamFound; // l�ytyik� parametri tutkittavasta datasta
	NFmiPoint itsMinValueLatlon; 
	NFmiPoint itsMinValueGridPoint; // hilan x, y koordinaatti, indeksit alkavat 0:sta ja vasen ala kulma on 0,0 ja oikea yl�kulma on m-1, n-1
...
// t�ss� info luokassa on eri parametreille annettuja varoitus ja virhe rajoja
...
private:
	...
	bool fUse; // onko checker k�yt�ss� vai ei
	bool fAutomatic; // toimiiko checker ty�-threadissa automaattisesti, vaiko toimitaanko vai on-demandina eli nappia painamalla
