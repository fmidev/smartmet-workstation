...
private:
	...
	checkedVector<NFmiGridValuesCheck> itsCombinedParamChecks; // tässä on koosteet jokaisesta parametrista (yli kaikkien aikojen)
	std::auto_ptr<NFmiQueryData> itsDataPtr; // data välitetään tänne ja säilytetään auto_ptr:ssa, siksi että olisi varmaa että 
