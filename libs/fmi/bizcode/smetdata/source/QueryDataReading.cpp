...
namespace
{
    ...
    void DoLatestDataReadingProblem(const NFmiFileString &theFileName, const std::string &theExceptionMsg, bool badAllocExeption)
    {
        ...
        { // jos smartmet teksti l�ytyi messagesta, tai oli bad_alloc-exception, laitetaan t�h�n varoitus messageBox yhden kerran, ett�
...
namespace QueryDataReading
{
    ...
    // kyseisell� filterill� l�ytyv�st� tiedostoista.
