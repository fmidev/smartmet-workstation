...
namespace
{
    ...
    // T�m� siis rajoittaa kun tehd��n level-datasta jokaiselle parametrille jokaiselle levelille omaa rivi� dialogiin.
    // Dialogi voisi jumitell� todella pahasti, jos tulee data, miss� olisi vaikka 8000 leveli� ja muutama (esim. 8) parametria
