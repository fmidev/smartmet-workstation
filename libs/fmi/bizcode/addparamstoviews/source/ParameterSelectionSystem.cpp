...
#include "CapabilitiesHandler.h" // Tuottaa C++17 ymp�rist�ss� ParameterSelectionSystem.cpp tiedostossa byte ongelman
...
namespace AddParams
{
    ...
    // Kun esim. luetaan Case-study dataa, pit�� koko systeemi alustaa uusiksi
    ...
    void ParameterSelectionSystem::clearData()
    {
        ...
        // Laitetaan t�m� false:ksi, jotta varmistetaan dialogin update toiminto my�hemmin
        updatePending_ = false; 
    ...
    void ParameterSelectionSystem::setMainDataFlagDirtyIfSubDataIsSet(bool value)
    {
        if(value)
        {
            // Jos jokin ali-data-lippu menee likaiseksi, pit�� my�s 'p��'-lippu liata
            dataNeedsUpdate(true);
        }
    }
    ...
    void ParameterSelectionSystem::setDialogDataFlagDirtyIfSubDataNeedsUpdate(bool value)
    {
        if(value)
        {
            // Jos jonkin ali-datan jokin kohta on muuttunut, pit�� my�s dialogiDatan-lippu liata
            dialogDataNeedsUpdate(true);
        }
    }
    ...
    bool ParameterSelectionSystem::hasActualGridData(const SingleRowItem& row)
    {
        ...
        // Editoitavan datan erikoistapaus: aikasarjaan pit�� hyv�ksy� editoitava data, vaikka 
        // sit� ei l�ydy infoOrganizerilta (sille l�ytyy syy) ja se ei ole hiladataa.
	...
	{
        // Ensin pit�� blokata mahdolliset lightning tyyppiset datat, sill� niit� ei voi visualisoida aikasarjassa.
        auto info = getFastInfo(*infoOrganizer_, row.uniqueDataId());
        if(info)
        {
    ...
    void ParameterSelectionSystem::SetLastActiveIndexes(unsigned int desktopIndex, int rowIndex)
    {
        ...
        {
            // Jos muutetaan n�ytt�� niin t�ll�in pit�� Parameter-selection dialogia 
            // p�ivitt��. On siis sallittua vaihtaa kartta1:st� kartta2:een ilman ett� pit�� p�ivitell�.
            dialogDataNeedsUpdate(true);
    ...
    int ParameterSelectionSystem::GetLastActivatedRowIndexFromWantedDesktop(unsigned int desktopIndex) const
    {
        if(isMapViewCase())
            ...
            return 1; // virhe, pit�isi oikeasti kai heitt�� poikkeus
    }
