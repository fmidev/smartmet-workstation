...
namespace
{
    // SmartMetin CaseStudy moodi laitetaan t�h�n talteen, jotta voidaan j�tt��
    // normi moodissa tietyt datat (satelliittikuva datat, jotka on muuten k�yt�st� poistetut) 
    // pois dialogista. Jos taas ollaan CaseStudy moodissa, silloin ne lis�t��n k�ytt��n, 
