...
{
    // SmartMetin karttan�ytt� ruudukun maksimi koot x- ja y-suunnassa
    const int MaxViewGridXSize = 10;
    const int MaxViewGridYSize = 5; // t�m� on my�s viewcachen max rivikoko
   ...
   std::string GetLatitudeMinuteStr(double lat, int decimals); // desimaali jutut toimivat nyt vain niin ett� jos 0, ei desimaaleja, muuten yksi desimaali
   ...
   // Haetaan sortatusta container:ista value:ta l�himm�n arvon elementin indeksi.
   // Koodi haettu: https://stackoverflow.com/questions/698520/search-for-nearest-value-in-an-array-of-doubles-in-c
   template <typename BidirectionalIterator, typename T>
