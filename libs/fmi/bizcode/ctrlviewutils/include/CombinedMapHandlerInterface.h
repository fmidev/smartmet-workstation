...
public:
    ...
    virtual void onSetTimeBoxLocation(unsigned int mapViewDescTopIndex, FmiDirection newPosition) = 0;
    virtual void onSetTimeBoxTextSizeFactor(unsigned int mapViewDescTopIndex, float newSizeFactor) = 0;
