...
// T�m� liittyy CPManagerin vaihtoon (kun niit� on setti k�yt�ss�).
//  Eli otetaan kaikki ulkoiset tekij�t theOther:ista k�ytt��n: 
...
// kontrolloida, lis�t��nk� aktiivinen jo aktiivisten listaan vai
...
bool NFmiEditorControlPointManager::ActivateNextCP()
{
    ...
    {
        // Deaktivoidaan l�ydetty piste, ja aktivoidaan sit� seuraava
...
bool NFmiEditorControlPointManager::ActivatePreviousCP()
{
    ...
    {
        // Deaktivoidaan l�ydetty piste, ja aktivoidaan sit� edellinen
        ActivateCP(activeCpIndex - 1, true);
        return true;
    }
}
...
// Palauttaa tiedon, siirtyyk� annetun indeksin osoittama CP paikkaa ajassa?
...
// Asettaa tiedon, siirtyyk� annetun indeksin osoittaman CP:n paikka ajassa?
// jos annettu indeksi on -1, k�ytt�� itsCPIndex:i�
