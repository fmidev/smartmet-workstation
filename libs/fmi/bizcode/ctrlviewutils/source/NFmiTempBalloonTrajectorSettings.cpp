...
// laske currentilla arvoilla nousu/laskunopeus yksik�ss� hPa/s. Osaa tehd� p��telmi� eri luotaus pallon lennon
...
double NFmiTempBalloonTrajectorSettings::CalcOmega(double Z, int theTimeStepInMinutes)
{
    ...
    case kNoDirection: // eli pallo on t�rm�nnyt jo maahan tai data on ollut puutteellista
