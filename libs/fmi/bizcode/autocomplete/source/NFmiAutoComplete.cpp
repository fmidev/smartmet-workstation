...
,     { "id": 651980,"name": "Kokemäki","country": "FI","feature": "PPL","area": "","lon": "22.35","lat": "61.25","timezone": "Europe/Helsinki" }
,     { "id": 651979,"name": "Kokinkylä","country": "FI","feature": "PPL","area": "Espoo","lon": "24.7589","lat": "60.1831","timezone": "Europe/Helsinki" }
,     { "id": 840742,"name": "Kokkila","country": "FI","feature": "PPL","area": "Siuntio","lon": "24.0303","lat": "60.1856","timezone": "Europe/Helsinki" }
,     { "id": 651982,"name": "Kokemäenkartano","country": "FI","feature": "PPL","area": "Kokemäki","lon": "22.3","lat": "61.2333","timezone": "Europe/Helsinki" }
,     { "id": 651976,"name": "Kokkihenna","country": "FI","feature": "PPL","area": "Orimattila","lon": "25.5","lat": "60.8167","timezone": "Europe/Helsinki" }
,     { "id": 651972,"name": "Kokkila","country": "FI","feature": "PPL","area": "Hämeenlinna","lon": "24.6667","lat": "61.1333","timezone": "Europe/Helsinki" }
...
static std::wstring g_TestAutoCompleteString = L"{\"autocomplete\": {  \"result\": [     { \"id\": 657157,\"name\": \"Pariisi\",\"country\": \"FR\",\"feature\": \"PPL\",\"area\": \"\",\"lon\": \"2.53333\",\"lat\": \"49.0167\",\"timezone\": \"Europe/Paris\" },     { \"id\": 651980,\"name\": \"Kokemäki\",\"country\": \"FI\",\"feature\": \"PPL\",\"area\": \"\",\"lon\": \"22.35\",\"lat\": \"61.25\",\"timezone\": \"Europe/Helsinki\" },     { \"id\": 651979,\"name\": \"Kokinkylä\",\"country\": \"FI\",\"feature\": \"PPL\",\"area\": \"Espoo\",\"lon\": \"24.7589\",\"lat\": \"60.1831\",\"timezone\": \"Europe/Helsinki\" },     { \"id\": 840742,\"name\": \"Kokkila\",\"country\": \"FI\",\"feature\": \"PPL\",\"area\": \"Siuntio\",\"lon\": \"24.0303\",\"lat\": \"60.1856\",\"timezone\": \"Europe/Helsinki\" },     { \"id\": 651982,\"name\": \"Kokemäenkartano\",\"country\": \"FI\",\"feature\": \"PPL\",\"area\": \"Kokemäki\",\"lon\": \"22.3\",\"lat\": \"61.2333\",\"timezone\": \"Europe/Helsinki\" },     { \"id\": 651976,\"name\": \"Kokkihenna\",\"country\": \"FI\",\"feature\": \"PPL\",\"area\": \"Orimattila\",\"lon\": \"25.5\",\"lat\": \"60.8167\",\"timezone\": \"Europe/Helsinki\" },     { \"id\": 651972,\"name\": \"Kokkila\",\"country\": \"FI\",\"feature\": \"PPL\",\"area\": \"Hämeenlinna\",\"lon\": \"24.6667\",\"lat\": \"61.1333\",\"timezone\": \"Europe/Helsinki\" },     { \"id\": 651973,\"name\": \"Kokkila\",\"country\": \"FI\",\"feature\": \"PPL\",\"area\": \"Lappeenranta\",\"lon\": \"28.55\",\"lat\": \"60.9833\",\"timezone\": \"Europe/Helsinki\" } ], \"found-results\": 8, \"max-results\": 8 }}";
...
void NFmiAutoComplete::InitFromSettings(const std::string &theBaseNameSpace)
{
	...
	itsKeyWordList = NFmiStringTools::Split(keyWordListStr, ","); // pitäisi olla pilkulla erotettu lista avainsanoja, mitä voidaan käyttää haussa
	...
	try
	{
		...
		else
		{
			...
			if(itsKeyWordList.size() == 0)
				wantedParams += "ylewww_fi"; // mitä vaihtoehtoja tähän löytyy?
			else
				wantedParams += itsKeyWordList[0]; // otetaan tässä vaiheessa vain 1. listasta
...
static void ParseJsonLocations(json_spirit::wValue &theValue, std::vector<NFmiACLocationInfo> &theLocationsOut)
{
	...
	{
		// autoCompleteObject:in nimi on "autocomplete", en tarkista, koska jos joku joskus muuttaa sitä homma ei tulevaisuudessa pelitä enää
		...
		{
			// autoCompletePair:in nimi on "autocomplete", en tarkista, koska jos joku joskus muuttaa sitä homma ei tulevaisuudessa pelitä enää
			auto autoCompletePair = autoCompleteObject[0];
			if(autoCompletePair.value_.type() == json_spirit::obj_type)
			{
				// resultObject:in nimi on "result", en tarkista, koska jos joku joskus muuttaa sitä homma ei tulevaisuudessa pelitä enää
				auto resultObject = autoCompletePair.value_.get_obj();
				for(auto it = resultObject.begin(); it != resultObject.end(); ++it)
				{
					// täällä etsitään sitä paria missä on "result" nimenä, koska on muitakin pareja resultObject-vektorissa
