...
std::string NFmiMacroParamDataInfo::CheckDataStorageFileFilter(const std::string& dataStorageFileFilter)
{
    ...
    // Tällä tarkoitus estää datojen vahinkotalletuksia vääriin paikkoihin.
    ...
    // 2. Tiedoston nimessä pitää olla '*' merkki aikaleimaa varten.
    ...
    // 3. Tiedoston nimessä pitää olla vähintään 3 alpha-numeerista merkkiä, jotta esim. pelkkä path\*.sqd ei kelpaa
    ...
    // 4. Tiedoston extension pitää olla sqd tyyppinen
