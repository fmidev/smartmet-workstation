...
// Piirretyt v�lilehdet (= n�ytt� rivit), eli tuottteessa voi olla esim. 1-50 kpl animaatio sarjoja.
// Mist� n�yt�st� tuote tehd��n. 
...
private:
    ...
    bool fUseUtcTimesInTimeBox; // K�ytet��nk� kuvissa olevissa vaaleissa aikaa merkitseviss� laatikoissa UTC aikaa vai lokaali aikaa
    ...
    std::string itsOriginalViewMacroPath; // T�h�n talletetaan se polku, mink� k�ytt�j� on antanut dialogissa, t�m� talletetaan my�s lopulta tiedostoon
    ...
    std::string itsSynopStationIdListString; // Mist� kaikista synop asemista halutaan tehd� kuvia (k�y vain tietyille n�yt�ille ja moodeille)
...
// Miten tuote trigger�id��n (joku kolmesta vaihtoehdosta): 
//  - fiksatut ajat (vuorokauden tunti+minuutti lista)
//  - haluttu steppi ja offset minuutti vuorokauden 00:00 ajasta
//  - data trigger�inti: joku tietty data/datat laukaisee/laukaisevat tuotannon
...
//  - v�lilehden 1. l�ytyneen mallidatan alkuaika
...
//  - v�lilehden 1. l�ytyneen mallidatan loppuaika
...
private:
    ...
    // tekstej� ja t�m� tulee my�s CFmiBetaAutomationDialog -dialogin teksteihin
    ...
    // t�m� talletetaan my�s lopulta tiedostoon
    ...
    // T�m� tieto l�ytyy NFmiBetaProductionSystem -luokasta. Annan siis n�ille luokille k�ytt��n 
...
public:
    ...
    bool fEnable;
    std::string itsBetaProductAutomationPath; // T�h�n yritetaan saada beta-product -base-directoria vastaava suhteellinen polku jos mahdollista. T�m� talletetaan my�s json-objectiin tiedostoon
...
private:
    ...
    static BaseDirectoryGetterFunctionType itsBetaProductionBaseDirectoryGetter; // T�m� tieto l�ytyy NFmiBetaProductionSystem -luokasta. Annan siis n�ille luokille k�ytt��n kyseisen luokan metodin, jolta polku tarvittaessa pyydet��n (n�in luokien ei tarvitse tiet�� toisistaan mit��n)
};
...
private:
    ...
    NFmiMetTime itsBetaProductRuntime; // Mill� hetkell� on kuvatuotantoa alettu tekem��n (k�ytet��n jos display runtime info k�yt�ss�)
    ...
    boost::shared_ptr<CachedRegBool> mBetaProductUseUtcTimesInTimeBox; // K�ytet��nk� kuvissa olevissa vaaleissa aikaa merkitseviss� laatikoissa UTC aikaa vai lokaali aikaa
    ...
    boost::shared_ptr<CachedRegBool> mBetaProductUseAutoFileNames; // Nimet��nk� tiedosto nimet automaattisesti tyyliin validtime_obs.png ja validTime_for.png, vai annetaanko k�ytt�j�n antaa tiedostonimi templaatti
    ...
    boost::shared_ptr<CachedRegInt> mBetaProductSelectedViewIndex; // Valitun n�yt�n indeksi (0=main-map-view, 1 = map-view-2, 2 = map-view-3, 3 = time-serial-view, 4 = sounding-view, 5 = cross-section-view)
    ...
    boost::shared_ptr<CachedRegString> mBetaProductSynopStationIdListString; // Mist� kaikista synop asemista halutaan tehd� kuvia (k�y vain tietyille n�yt�ille ja moodeille)
    ...
    // Beta Product Automation dialog tab control settings
    boost::shared_ptr<CachedRegBool> mAutomationModeOn; // Onko SmartMet ns. Beta tuotanto automaatio moodissa, jolloin kuvia tuotetaan s��d�sten mukaan haluttuina aikoina.
