...
// ListChildren listaan. Lis�t��n my�s tyhj�� sana listaan, jotta tarkastelut  yksinkertaistuvat.
static const std::vector<std::string> g_IgnoredConfigurationVariableNames{ "", g_VersionNumberName, g_SmartmetServerBaseUriName };

// Seuraavan alkuiset sanat ignoorataan my�s (n�ill� listataan n kpl server url:eja)
...
// mit� on konffeissa, pit�� arvot ottaa k�ytt��n konffeista.
#ifndef UNIX
bool SoundingDataServerConfigurations::mustDoConfigurationOverride(HKEY usedKey)
{
    ...
    {
        // Uusi versio numero pit�� ottaa my�s talteen Win-rekisteriin
...
std::string SoundingDataServerConfigurations::makeBaseUrlParameterString(const NFmiMetTime& validTime, const NFmiPoint& latlon) const
{
    ...
    // Ei haeta origintime:n avulla, haetaan toistaiseksi vain viimeisint� mallidataa, joka l�ytyy serverilt�
