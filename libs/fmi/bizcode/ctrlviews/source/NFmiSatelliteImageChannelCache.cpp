...
// py�riv�st� p�ivitys worker-threadista, siksi mImageCacheSet pit�� synkronisoida.
// Palauttaa true, jos on tullut uusia kuvia k�ytt��n, tai kuvia on poistunut.
...
{
    DoPossibleForceUpdate(); // HUOM! Pit�� olla ennen scoped_lock:ia, koska DoPossibleForceUpdate:n sis�ll� tapahtuu my�s sama lukitus!!
    ...
    {   // Ei l�ytynyt tarkkaa aikaa, katsotaan viel� onko k�yt�ss� aikahaarukka ja etsit��n t�ll�in l�hint� aikaa
