...
namespace CtrlView
{
    ...
    void OpenWantedUrlInBrowser(SmartMetOpenUrlAction currentOpenUrlAction, int mapViewDescTopIndex)
    {
        if(currentOpenUrlAction != SmartMetOpenUrlAction::None)
        {
            ...
            {
                // Jos distance measure ty�kalua ei ole viel� k�ytetty, palauttaa se mitatun matkan pituudeksi -1:n,
                // t�ll�in laitetaan vain joku default arvo eli vaikka 50 km
