...
void NFmiTempView::SetupUsedSoundingData(NFmiSoundingData& theUsedDataInOut, int theProducerIndex, bool fMainCurve)
{
...
void NFmiTempView::DrawSounding(NFmiSoundingData &theUsedDataInOut, int theProducerIndex, const NFmiColor &theUsedSoundingColor, bool fMainCurve, bool onSouthernHemiSphere)
{
...
void NFmiTempView::DrawStationInfo(NFmiSoundingData &theData, int theProducerIndex)
{
