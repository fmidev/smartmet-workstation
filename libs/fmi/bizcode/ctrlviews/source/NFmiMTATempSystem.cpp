...
// N‰ille viiva asetuksille pit‰‰ antaa valmiit oletusarvot, koska n‰it‰ ei v‰ltt‰m‰tt‰ lˆydy asetuksista
...
{
    try
    { // yritet‰‰n hakea asetuksista arvoja, mutta jos niit‰ ei lˆydy, otetaan poikkeus kiinni ja j‰tet‰‰n oletusarvot
...
void NFmiMTATempSystem::InitializeSoundingColors(void)
{
	...
	// ********* initialisoidaan viel‰ luotaus n‰ytˆn kaikki viiva systeemit ********
...
{
    // 4. extra tuottajat, jotka saadaan myˆs docilta
...
void NFmiMTATempSystem::Write(std::ostream& os) const
{
	...
	extraData.Add(itsHodografViewData.GenerateSettingsString()); // 3. uusi string arvo extroissa on hodografi s‰‰dˆt
...
// Jos textual-sounding sivuikkuna on auki, avataan se myˆs legacy n‰yttˆmakroissa, 
...
{ // toivottavasti olet poistanut kommentit luettavasta streamista!!
	...
	{
		// Version 5.13.12.0 j‰lkeisill‰ versioilla tehty n‰yttˆmakro hanskataan k‰ytt‰m‰ll‰ extraData arvoja suoraan
...
void NFmiMTATempSystem::InitFromViewMacro(const NFmiMTATempSystem &theOther)
{
	...
	// Pit‰isikˆ myˆs itsSoundingDataServerConfigurations asetukset kopioida t‰ss‰???
