...
namespace
{
	...
	// 90% rajasta tuleekin oikeasti 89.99999%. T�ll�in isoviivat kiertavat kauniisti 90% arvot.
	...
	// Jos l�pik�yt�v� v�ri on transparentti, pit�� se yhdist�� seuraavaan v�riin, jos sellainen l�ytyy.
	// Jos seuraava v�ri-indeksi on my�s transparentti, ei tehd� yhdistely�.
	...
	// turhan takia hidastuu, t�ll�in halutaan etsia sopiva steppi, mill� saadaan riitt�v�n
	...
	// vastaavasta 1:ll�. T�ll�in n�iden kahden v�rin v�liin mahtuu 6 v�ri� v�rikuutiosta,
	// t�ll�in funktio palauttaa maksimi arvon 6.
	// Jos v�rien maksimi kanava ero on 0, t�ll�in v�rit ovat k�yt�nn�ss� samoja ja 
	...
	// mutta niiden v�liin ei voi laskea yht��n uutta v�ri�, t�ll�in steppien m��r� on my�s 0.
...
// Niiden m��r� riippuu siit� k�ytet��nk� color blendausta vai ei.
...
// Poistetaan my�s limit+v�ri, jos kahden per�kk�isen limitin arvo on sama (tyhj� v�li, jolloin j�lkimm�inen raja+v�ri poistuu).
...
void ColorContouringData::missingLimitCleanUp()
{
	...
	if(limitsSize && colorsSize)
	{
		...
		for(size_t index = 0; index < limitsSize && index < colorsSize - 1; index++)
		{
			...
			{
				// 3. Siivotaan my�s pois sellaiset rajat (ja v�rit), miss� per�kk�iset limitit ovat samoja (et�isyys on 0)
...
// T�m�n gToolMasterContourLimitChangeValue- globaalin muuttujan k�ytt� on j��nyt minulle nyt hieman h�m�r�n peittoon,
