...
private:
	...
	checkedVector<NFmiColor> itsSoundingColors; // eri luotaukset piirretään eri väreillä, tähän on ne värit talletettu
	...
	checkedVector<double> itsPressureValues; // nämä paine pinnat piirretään ja niihin laitetaan label
	...
	checkedVector<double> itsMixingRatioValues; // nämä mixing ratio arvot piirretään ja niihin laitetaan label
	...
	checkedVector<double> itsMoistAdiabaticValues; // nämä kostea adiabaatti arvot piirretään ja niihin laitetaan label
	...
	checkedVector<double> itsDryAdiabaticValues; // nämä kuiva adiabaatti arvot piirretään ja niihin laitetaan label
