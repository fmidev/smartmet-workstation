...
class NFmiColorContourLegendValues
{
    ...
    // Simple contour vs custom contours: simpleiss‰ limit ja color lukum‰‰r‰t samoja, customissa coloreita on 1 enemm‰n.
    // => v‰rien blendaus laskut menev‰t erilailla ja piirto menee erilailla.
