...
private:
    ...
    bool mChannelShownOnView; // Onko kyseinen satel-kanava valittuna jollekin karttan�yt�lle, jos on, t�ll�in tehd��n cache-tiedosto p�ivityksi� (tausta s�ikeess�) useammin
    ...
    ImageCacheSortedList mImageCacheSortedList; // T�ss� on palvelimelta l�ytyv�t satel-cache kuvat aikaj�rjestyksess�, t�t� on pakko synkronoida mutexin avulla, koska t�t� p�ivitet��n ja k�ytet��n eri s�ikeist�
    ...
    std::shared_ptr<NFmiArea> mImageArea; // Satel-kuvan konffeissa on m��r�tty alue, jonka kuvan alue peitt��
};
