...
class NFmiTempView : public NFmiCtrlView
{
 ...
 private:
	...
	// first-dataa käytetään myös luotausten muokkauksessa!!!!
	NFmiSoundingDataOpt1 itsFirstSoundingData; // tähän talletetaan 1. piirrettävän luotauksen datat, että niitä käytetään indeksi osio laskuissa
	...
	std::string itsSoundingIndexStr; // tähän talletetaan ain piirretty stabiilisuus indeksi teksti rimpsu / luotaus numeroina, riippuen mikä moodi on valittuna
