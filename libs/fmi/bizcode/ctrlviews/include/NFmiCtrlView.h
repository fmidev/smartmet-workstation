...
class NFmiCtrlView
{
 ...
 protected:
	...
	// aikaa tarvitaan joissain n�ytt�luokissa, joten laitoin ajan asetuksen mukaan
	...
	// Tehd��n parametrin nimi pareina, toinen n�yt�n piirtoa varten ja toinen tooltippej� varten. Se miss� on tooltip versio, hanskaa
