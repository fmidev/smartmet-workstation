...
namespace
{
    ...
    std::string GetFirstNoneEmptyLine(std::istream& input)
    {
        ...
        {
            // Sy�te oli jo lopussa, palautetaan vain tyhj��
            return "";
        }
    }
    ...
    {
        // Haetaan ensimm�inen ei-puuttuva aika listasta ja py�ristet��n se seuraavaan tasatuntiin.
        ...
        // Jos luotaus datasta ei l�ydy mit��n j�rkev�� aikaa, ei kannata tehd� sit� ollenkaan
    ...
    // 5. Joka kohdassa kysyt��n onko nyt tyhj� rivi vai ei ja tehd��n p��t�ksi� sen mukaan
