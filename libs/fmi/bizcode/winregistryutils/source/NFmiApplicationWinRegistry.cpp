...
{
    // Asetetaan visualisointiin liittyvä range-limit 0:ksi, tällöin se on rajaton, 
    // eli CP-pisteen vaikutus leviää rajattomasti, kuten se on tähän mennessäkin toiminut.
