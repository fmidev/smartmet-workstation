...
private:
	...
	std::string itsImageAreaStr; // jos kyse on kuva-datasta, pit�� tallettaa my�s kuvan alue
	NFmiParam itsImageParam; // jos kyseess� kuva-data, pit�� tallettaa my�s parametrin id ja nimi
	...
	bool fDataEnabled; // T�m� tieto tulee NFmiHelpDataInfo:n IsEnabled-metodista. Eli k�ytt��k� SmartMet kyseist� dataa alkuunkaan. Jos t�m� on false, ei sit� talletetan dataan vaikka store-asetus olisi true.
...
private:
	...
	boost::shared_ptr<CachedRegBool> fCropDataToZoomedMapArea; // Laikataanko datat pienemm�ksi (jos mahdollista) p��karttan�yt�n zoomin perusteella
    std::string itsSmartMetLocalCachePath; // polku johon smartmet tallettaa queryDatat, jos data l�ytyy t�m�n polun alta, sen koko voidaan aina arvioida
