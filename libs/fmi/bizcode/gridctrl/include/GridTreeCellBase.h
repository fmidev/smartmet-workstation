...
protected:
    ...
    int      m_iCol;
    COLORREF   m_crBkClr; // Marko ohitin yhteisen taustavärin, joka tuli ennen yhteiseltä CTreeColumn-instanssilta
    LOGFONT*   m_plfFont; // Marko ohitin yhteisen erityisfontin, joka tuli ennen yhteiseltä CTreeColumn-instanssilta
