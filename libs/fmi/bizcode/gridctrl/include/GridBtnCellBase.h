...
public:
    ...
    BOOL SetupBtns(  int aiWhich,        // zero-based index of image to draw
                     ...
                     LPCTSTR apszText);   // Text to insert centered in button; if NULL no text
...
public:
    ...
    virtual void SetDrawCtlBtnText(int /* aiWhich */, LPCTSTR /* apszText */)
        { ASSERT( FALSE); }
...
public:
	...
	{ 
        if( m_pBtnDataBase)
            return m_pBtnDataBase->IsDefaultFont();
        return FALSE;
	}
