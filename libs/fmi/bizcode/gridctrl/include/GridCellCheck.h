...
// Operations
	...
	typedef boost::function<void (int, int) > CheckBoxClickedCallback;
	void SetCheckBoxClickedCallback(CheckBoxClickedCallback theCallbackFunction) {itsCallbackFunction = theCallbackFunction;}
...
protected:
    BOOL  m_bChecked;
    CRect m_Rect;
	CheckBoxClickedCallback itsCallbackFunction;
};
