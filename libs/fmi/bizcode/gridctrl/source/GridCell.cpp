...
// Marko: Vanhan CGridCtrl version koodi toimii kun buildataan Win7:lla ja käytetään XP:ssä
// Vanha koodi alkaa --->
...
//    VERIFY(SystemParametersInfo(SPI_GETNONCLIENTMETRICS, sizeof(NONCLIENTMETRICS), &ncm, 0));
    VERIFY(SystemParametersInfo(SPI_GETNONCLIENTMETRICS, iRealSize, &ncm, 0));
// --> Vanha koodi loppuu

// Uusi CGridCtrl ver 2.27 koodi ei siis toimi, kun buildattu Win7:lla ja exe ajetaan XP:ssä
// Uusi epätoimiva koodi alkaa -->
/*
    NONCLIENTMETRICS ncm;
