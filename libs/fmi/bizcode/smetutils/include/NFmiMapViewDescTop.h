...
private:
	...
	// Kun n�ytt�ruudukkoa klikataan hiirell�, yksi ruuduista muuttuu aktiiviseksi. 
	...
	// Kun karttan�ytt�� printataan, laitetaan t�m� p��lle, jotta kartta-alue saadaan aina maksimiksi eli (0,0-1,1).
	...
	// Rajat t�lle s��d�lle on laitettu 0.5 - 2.5.
