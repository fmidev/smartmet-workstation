...
private:
	...
	bool fMapDirty;
	bool fMapReallyChanged; // t‰m‰n avulla tiedet‰‰n onko karttaa oikeasti zoomattu, edell‰ olevaa mapDirty:‰ voidaan k‰ytt‰‰ muissakin tapauksissa
	...
	std::string itsControlPath; // smartmetin kontrollipolku (-p optio) pit‰‰ laittaa talteen, koska muuten ohjelma ei aina
