...
// ======================================================
// 1. mapDirty, jos true, on tarve laskea uusi zoomaus karttapohjalle ja samalla piirt‰‰ karttapohja uudestaan cacheen.
// 2. clearCache, jos true, tyhjennet‰‰n karttan‰yttˆjen kuva-cachet t‰ysin. Kuva cache:lla tarkoitetaan eri 
...
// 3. areaViewDirty parametrilla s‰‰det‰‰n piirret‰‰nkˆ karttan‰yttˆ uudestaan, vai k‰ytet‰‰nkˆ piirrossa suoraan
