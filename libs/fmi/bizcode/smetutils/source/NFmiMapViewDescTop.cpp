...
,itsRelativeMapRect(0.,0.,1.,0.9) // t�m�n suhteellisen osan n�yt�st� valtaa kartasto, loput menee aikakontrolli ikkunalle
...
void NFmiMapViewDescTop::InitMapViewDescTopFromSettings(void)
{
    ...
    ShowTimeOnMapMode(itsShowTimeOnMapMode); // t�m� asettaa my�s fShowTimeString:in arvon oikeaan
...
// N�kyyk� kyseinen karttarivi nyt karttan�yt�ss�. TheRowIndex on rivi indeksi, jonka arvo alkaa 1:st�.
...
// 2. clearMapViewBitmapCacheRows, jos true, tyhjennet��n karttan�ytt�jen kuva-cachet t�ysin. Kuva cache:lla tarkoitetaan eri 
//    n�ytt�riveill� olevat eri aika-askeleilla olevat karttapohjan ja parametri piirto-layereiden yhteistulos.
//    T�h�n cache kuvaan ei kuulu ns. DrawOverBitmaptThings, joilla piirret��n erilaisia merkkej� karttan�yt�ille.
// 3. redrawMapView parametrilla s��det��n piirret��nk� karttan�ytt� uudestaan, vai k�ytet��nk� piirrossa suoraan
//    karttan�ytt�-luokkien (CSmartMetView ja CFmiExtraMapView) tallettamaa cache kuvaa. T�m� yksitt�inen cache kuva on 
//    siis vain kulloisellakin hetkell� k�yt�ss� siksi ett� piti tehd� double-buffer kuva, jos esim. toinen ohjelma/n�ytt� 
//    siirret��n SmartMet n�ytt�jen yli ja niit� ei tarvitse muuten p�ivitt��.
// 4. updateMapViewDrawingLayers parametrilla varmistetaan ett� karttan�ytt�luokat tekev�t p�ivityksi� piirto-layer rakenteisiin.
#ifndef UNIX
...
void NFmiMapViewDescTop::MapViewSizeInPixels(const NFmiPoint& newSize, CDC* pDC, double theDrawObjectScaleFactor, bool fHideTimeControlView)
{
	...
	{
		// S��det��n samalla suhteellista osiota, mink� karttan�ytt� ottaa ja j�tt�� loput aikakontrolli-ikkunalle.
...
int NFmiMapViewDescTop::ToggleShowTimeOnMapMode(void)
{
	...
	if(itsShowTimeOnMapMode > 3)
		itsShowTimeOnMapMode = 0;
	// Jos vaikka on luettu joku negatiivinen luku n�ytt�makrosta, se pit�� korjata
	...
	// Kartta-alueen koot pit�� my�s p�ivitt��, jos aikakontrolli-ikkuna menee pois n�kyvist� tai tulee taas n�kyviin
...
bool NFmiMapViewDescTop::BorderDrawBitmapDirty(NFmiDrawParam* separateBorderLayerDrawOptions) const
{
	if(separateBorderLayerDrawOptions)
	{
		...
		return (bitmap == nullptr); // Jos ei l�ydy erillis-layer-cachesta kuvaa, on se 'likainen'
	}
	else
...
bool NFmiMapViewDescTop::SetMapViewGrid(const NFmiPoint &newValue, NFmiMapViewWinRegistry *theMapViewWinRegistry)
{
	...
	MapRowStartingIndex(MapRowStartingIndex()); // HUOM! pit�� my�s s��t�� aloitus rivi
...
{
    // lasketaan my�s yhden kartta ruudun koko mm uudestaan
...
void NFmiMapViewDescTop::Write(std::ostream& os) const
{
	...
	// itsDrawParamListVector; // T�m�n talletus tehd��n erikseen n�ytt�makroluokassa
	// itsExtraDrawParamListVector; // T�m�n talletus tehd��n erikseen n�ytt�makroluokassa
    ...
    // N�ytt�makrojen taakse/eteenp�in yhteen sopivuuden nimiss�, t�m� pit�� tallettaa falsena
...
void NFmiMapViewDescTop::Read(std::istream& is)
{
    ...
    // N�ytt�makrojen taakse/eteenp�in yhteen sopivuuden nimiss�, t�m� pit�� lukea
    bool legacy_fShowRedCrossOverMapIfNotEditedDataTime = false;
	...
	// vanhalla versiolla tehdyn n�ytt�makron showParamWindowView muuttujaan luetusta originaali asetuksesta.
...
void NFmiMapViewDescTop::MapViewDisplayMode(CtrlViewUtils::MapViewMode newValue)
{
	...
	// Kutsutaan lopuksi viel� skrollaus-metodia 0-siirrolla. T�m� asettaa n�ytt�rivit niin, 
...
//    ett� seuraavalla piirrooskierroksella n�ytt� pit�� piirt�� uusiksi, eik� saa vain k�ytt�� double buffer bitmap:ia.
