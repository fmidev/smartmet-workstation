...
{
    // Normaalisti NFmiMetTime::NearestMetTime(60) pyˆrist‰‰ seuraavaan tuntiin, jos minuutti on 30, 
...
static NFmiMetTime GetSuitableAnalyzeToolInfoTime(const NFmiMetTime &latestInfoTime, boost::shared_ptr<NFmiFastQueryInfo> &editedInfo)
{
    ...
    {
        // Jos aikaa ei ollut suoraan editoidussa datassa, palautetaan vain varmuuden vuoksi l‰himp‰‰n tuntiin pyˆristetty aika
