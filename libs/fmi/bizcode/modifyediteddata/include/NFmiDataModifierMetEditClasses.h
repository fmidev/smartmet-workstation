...
{ 
 ...
 protected:
	 ...
	 std::shared_ptr<NFmiFastQueryInfo> itsFirstParamInfo; // omistaa (yhdistettäville parametreille omat infot, jotta niitä ei tarvitsisi asetella jatkuvasti osoittamaan haluttuun parametriin)
...
{ 
 ...
 protected:
	 ...
	 std::shared_ptr<NFmiFastQueryInfo> itsFirstModelInfo; // omistaa (yhdistettäville parametreille omat infot, jotta niitä ei tarvitsisi asetella jatkuvasti osoittamaan haluttuun parametriin)
...
{ 
 ...
 protected:
	std::shared_ptr<NFmiFastQueryInfo> itsTemperatureInfo; // sama kuin kopio info muissa modifiereissa ja tätä juoksutetaan ajassa jo valmiiksi
