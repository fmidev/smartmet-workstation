...
//   mukaan liitet��n ty�version indeksi. "KEPA_SUOMI_48_1_3112_V1.sqd"
//   Versio saadaan katsomalla jo olemassa olevia ty�tiedostoja.
//
...
//--------------------------------------------------------
//   K�y ty�tiedostot l�pi ja etsii viimeisen version.
//
...
int NFmiDataLoadingInfo::LatestDataBaseInVersion(int theIndex)
{
	...
	if(foundFileName2.Search(newDateString)) // katsotaan l�ytyyk� samalla aikaleimalla se viimeisin tietokanta tiedosto
	{
