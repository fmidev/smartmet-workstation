...
void NFmiSynopPlotSettings::Init(void)
{
	...
	{
		throw; // laitetaan poikkeus eteenp�in vain
	}
}
...
void NFmiSynopPlotSettings::Read(std::istream& is)
{
	...
	{
		// Jos viewMacro talletus oli tehty vanhalla versiolla, pit�� antaa tyhj� string t�ss�, 
		// jotta saadaan halutu asetukset p��lle, eli kaikki parametrit n�kyviksi ja tietyt synop-plot optiot k�ytt��n
		std::string emptyStr;
