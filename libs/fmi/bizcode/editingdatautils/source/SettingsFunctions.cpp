...
namespace SettingsFunctions
{
    ...
    // *****
    // HUOM! ƒl‰ tee urlSlashReplaceStr -muuttujasta tiedoston sis‰ist‰ staattista muuttujaa tai laita sit‰
    // nimettˆm‰‰n namespace:n (n‰in sen saisi alustettua yhdell‰ kertaa molempiin funktioihin)
    // T‰m‰ siksi ett‰ jostain syyst‰ VC++ 2008 k‰‰nt‰j‰ ei saa alustettua muuttujaa kun alustetaan
