...
private:	
	...
	//   Kun tiedostoa luetaan, t‰m‰ on luettavan tiedoston versio.
	...
	checkedVector<NFmiString> itsSelectedFileNamesVector; // dialogissa valitut tiedostonimet talletetaan t‰h‰n
