...
public:
	...
	public:
	   ...
	   bool fMouseCaptured; // t�m� pit�isi siirt�� dokumenttiin??? siirret��nk� aikamuokkauskahvoja hiirell� vet�m�ll�
	   bool fMouseCapturedMoveTimeLine; // siirret��nk� hiirell� koko aikaikkunan alku/loppu aikoja
...
protected:
   ...
   FmiDirection itsAnimationDragDirection; // jos fMouseCapturedAnimationBox ollessa true, 
										...
										// jos arvo on kBase, luodaan animaatio laatikkoa, ja siin� on hieman eri s��nn�t, eli venytys voi tapahtua molempiin suuntiin
   ...
   bool fDrawViewInMouseMove; // eri n�yt�iss� (esim. p��karttan�yt�n alaosa ja muokkaudialogin aikakontrolli osa) ei (n�yt�n p�ivitys-tyylin takia) kannata piirt�� n�ytt�� aina MouseMove-metodissa kun se piirret��n muutenkin ja k�ytt�en double bufferointia
   double itsAxisShrinkFactor; // t�m� pienent�� n�yt�n aika-akselin leveytt� defaultti 0.02 tulee jostain kokeilusta
   ...
   static AnimationButtonImageHolder statAnimationButtonImages; // t�m� on staattinen dataosa, koska n�it� timekontrol-instansseja luodaan lennossa jatkuvasti uudelleen ja uudelleen eli bitmapit luetaan vain kerran kaikkien k�ytt��n
