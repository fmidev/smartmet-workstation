...
void NFmiTimeControlView::DrawResolutionChangerBox(void)
{
	if(fShowResolutionChangerBox)
	{
		...
		NFmiText dummyText(NFmiPoint(-11111, -11111), "", 0, &envi); // printataa ntyhj‰ kerran lasketulla fontilla, ett‰ voidaan laskea tekstin vaatima tila
...
{ // HUOM!! ei pid‰ tutkia onko hiiri ikkunan sis‰ll‰ vaan onko hiiri kaapattu!
    ...
    if(itsCtrlViewDocumentInterface->MouseCaptured())
    {
        ...
        // TƒMƒ AIHEUTTAA mouse movessa YLIMƒƒRƒISIƒ (MFC frameworkin aiheuttamia) esim. Temp-view p‰ivityksi‰, jotka ovat irrallaan smartmetin tekemist‰ p‰ivityksist‰
