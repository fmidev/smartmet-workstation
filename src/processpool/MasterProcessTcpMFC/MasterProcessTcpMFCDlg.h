...
// MasterProcessTcpMFCDlg.h : header file
//
...
class CMasterProcessTcpMFCDlg : public CDialogEx
{
// Construction
public:
	CMasterProcessTcpMFCDlg(const MasterProcessMFCOptions &options, CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	enum { IDD = IDD_MASTERPROCESSTCPMFC_DIALOG };
