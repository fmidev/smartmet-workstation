...
namespace
{
    ...
    // Jos jotain datoja ei l�ydy serverilt�, halutaan siit� raportoida eri paikkoihin, 
...
namespace LocalCacheSingleFileLoaderThread
{
    ...
    // 3. onko tmp-nimi jo cachessa (t�ll�in mahd. toisen SmartMetin kopio on jo k�ynniss�)
