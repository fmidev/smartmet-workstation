...
namespace
{
    ...
    // Onko SmartMet ns. operatiivisessa moodissa, eli silloin se automaattisesti latailee uusia datoja cacheen ja silloin my�s vanhoja pit�� siivoilla pois.
    ...
    int CalcMaxKeepFileCount(const NFmiHelpDataInfo& helpDataInfo, NFmiCaseStudySystem& caseStudySystem)
    {
        ...
        {
            return 1; // n�it� datatyyppeja on turhaa s�il�� 1 enemp��
        }
        else
        {
