...
public:
	...
	afx_msg void OnAcceleratorChangeTimeByDayForward();
	afx_msg void OnAcceleratorChangeTimeByDayBackward();
	afx_msg void OnAcceleratorChangeTimeByWeekForward();
	afx_msg void OnAcceleratorChangeTimeByWeekBackward();
	afx_msg void OnAcceleratorChangeTimeByMonthForward();
	afx_msg void OnAcceleratorChangeTimeByMonthBackward();
	afx_msg void OnAcceleratorChangeTimeByYearForward();
	afx_msg void OnAcceleratorChangeTimeByYearBackward();
