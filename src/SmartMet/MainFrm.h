...
public:
	...
	void SetDefaultValues(void){}; // tämä vaaditaan DoWindowSizeSettings -template funktion takia, mutta se ei tee mitään, koska pää ikkunaa ei voi laittaa defaultti paikkaan
