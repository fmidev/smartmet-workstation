...
int main(int argc, const char* argv[])
{
    ...
    // Tehd��n my�s kokonais lukemat ja niiden tulostus
    ...
    for(auto fileNamePart : fileNameParts)
    {
        try
        {
            ...
            if(fileNamePartSize == 12 || fileNamePartSize == 14)
            {
                ...
                usedTime = aTime;
                break; // lopetetaan kun on l�ytynyt 1. kunnon aikaleima tiedostonimest�
            }
...
// T�rkeimpi� ovat synop ja metar tiedostot, jos niit� l�ytyy, k�ytet��n sen datasetin 'sein�kelloaikana'
// mink� tahansa synop/metar datan viimeisint� validTimea. 
// Jos t�ll�ist� ei l�ydy, k�ytet��n mink� tahansa hiladatan (oletetaan ett� on ennuste) my�h�isint� ensimm�ist� validTimea.
// Jos t�ll�ist� ei l�ydy, k�ytet��n mink� tahansa asemadatan (oletetaan ett� on havainto)  my�h�isint� viimeist� validTimea.
// L�ydetyn sein�kelloajan avulla lasketaan siirtym� p�iviss�, joka palautetaan.
...
int main(int argc, const char* argv[])
{
    ...
    // 4) Uuden datan nimessa oleva aikaleima on my�s muokattu samalla siirtym�ll�.
...
int main(int argc, const char* argv[])
{
    ...
    // Testi 2: Luodaan monia samoja area olioita per�kk�in monimutkaisemmassa ymp�rist�ss�. 
    ...
    // metodiin NFmiAreaFactory::Create funktio kutsun ymp�rille (ks. NFmiNanoSecondTimer:in k�ytt�� yll�).
