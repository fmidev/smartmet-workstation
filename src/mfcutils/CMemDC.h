...
// MARKO: jouduin muuttamaan tämän nimen CMemDC -> CMemDC2, koska originaali nimi meni päällekkäin
// CGridCtrl-luokan käyttämän CMemDC-luokan kanssa. Linkatessa varmaan koodit menivät sekaisin
// ja kaikki CGridCtrl-luokan piirto kaatui CMemDC-luokan destruktoriin nimittäin tämän luokan tässä
// vaikka tätä käytetään vain CTextProgressCtrl-luokan kanssa.
