...
// Splitter systeemille pit�� antaa alkuarvot ennen kuin tehd��n muita s��t�j�.
void CDynamicSplitterHelper::PreResizerHookingSetup()
{
    // IDC_BUTTON_SPLITTER_SMARTTOOL kontrolli m��r�� splitterin alkuasennon
    // IDC_STATIC_SPLITTER_CONTROL kontrolli m��r�� koko h�k�tyksen originaali koon ja sijainnin 
    // eli n�iden avulla lasketaan koot ja sijainnit IDC_RICHEDIT_MACRO_TEXT- ja IDC_RICHEDIT_VIEW_ONLY_MACRO_TEXT -kontrolleille.
    CRect dividerRect(GetSplitterDividerRect());
    CRect totalSplitterRect(GetTotalSplitterRect());

    // Lasketaan halutun ration mukainen splitter-nappulan paikka ja siirret��n se siihen.
    // Splitter-nappulalla on minimi korkeus/leveys, lasketaan keskipisteen suhteen siirtym�t.
...
void CDynamicSplitterHelper::PostResizerHookingSetup()
{
    ...
    // Pit�� t�ytt�� molemmat splitterit (horisontaali ja vertikaali), mutta vain toinen niist� n�ytet��n
