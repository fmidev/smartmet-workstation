...
void CFmiModifyDrawParamDlg::ParamAbbreviation(void)
{
    ...
    if(!IsMacroParamCase() && itsParamAbbreviationStrU_.GetLength() > 15) // jos ei macroParam tyyppi‰ (niiden nimi‰ ei voi editoida), leikataan nimen lyhennetta niin ett‰ se on maksimissaan 15 merkki‰
