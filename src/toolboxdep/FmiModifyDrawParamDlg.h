...
public:
    ...
    CString	itsSpecialClassLabelColorIndicesStrU_; // ei lˆydy drawparamista!!!!! // k‰ytet‰‰n v‰liaikaisesti label korkeuden kanssa
	...
	// T‰m‰n muuttujan avulla v‰ritet‰‰n labeli tarvittaessa punaiseksi ett‰
	// k‰ytt‰j‰ n‰kee ett‰ annetut luokka rajat ovat virheellisi‰.
	// Suurin ongelma tulee kun kaikki arvot eiv‰t ole nousevassa j‰rjestyksess‰. T‰llˆin ohjelma toimii oudosti.
