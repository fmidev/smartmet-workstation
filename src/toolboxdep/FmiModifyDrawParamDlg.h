...
private:
	...
	std::shared_ptr<NFmiDrawParam> itsBackupDrawParam; // viel‰ yksi vara drawParam, jos joku haluaa katsoa muutoksia p‰ivitys-napista, muttasitten painaa
									  // lopuksi cancelia, t‰llˆin t‰‰ll‰ on originaali tallessa.
	std::shared_ptr<NFmiDrawParam> itsOrigDrawParam; // t‰m‰ on originaali data ja se on tallessa tallessa sit‰ varten ett‰ muutokset eiv‰t
