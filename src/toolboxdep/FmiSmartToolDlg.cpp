    ...
    if(!theMacroParamName.empty())
    {
        ...
        if(fDoSpeedLoad)
        {
            ...
            if(macroParamFound)
            {
                ...
                // Joku outo ongelma est‰‰ k‰ytt‰m‰st‰ edell‰ lˆydetty‰ pikahaku macroParamia, 
                // Siksi asetetaan haluttu macro viel‰ toisen kerran kun ollaan jo asetettu oikea
                // hakemisto ja tiedet‰‰n siin‰ haluttu macroParamin nimi.
                // T‰m‰ korjaa bugin: pikavalintana valitun macroParamin kaavan muokkaus ei
                // p‰ivity karttan‰ytˆll‰ olevan macroParamin laskuihin.
