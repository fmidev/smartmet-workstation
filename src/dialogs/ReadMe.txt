========================================================================
    STATIC LIBRARY : SmartMetDialogs Project Overview
========================================================================

AppWizard has created this SmartMetDialogs library project for you.

This file contains a summary of what you will find in each of the files that
make up your SmartMetDialogs application.


SmartMetDialogs.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named SmartMetDialogs.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "SmartMetDialogs.rc" and a "SmartMetDialogs.h" that
