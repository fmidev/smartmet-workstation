...
std::string NFmiParameterSelectionGridCtrl::TooltipForWmsDataCategoryType(const AddParams::SingleRowItem& singleRowItem, const std::vector<AddParams::SingleRowItem>& singleRowItemVector, int rowNumber)
{
    ...
    try
    {
        // Katsotaan l�ytyyk� seuraavalta rivilt� currentin rivin, joka on vasta data-tasoa 
...
BOOL CFmiParameterSelectionDlg::OnInitDialog()
{
    ...
    // Aletaan tarkastelemaan kerran sekunnissa ett� mik� on aktiivinen n�ytt� ja aktiivinen rivi ja p�ivitet��n tarvittaessa otsikon teksti� vastaavasti
...
// Palautetaan true, jos molemmat annetut indeksit ovat karttan�ytt� tyyppisi�
...
// Kun dialogi avataan '+' -napista, kutsutaan t�t� tehd��n kyseisen n�yt�n asetukset kuntoon,
// jotta parametrit lis�t��n sen n�yt�n aktiiviseen riviin.
void CFmiParameterSelectionDlg::SetIndexes(unsigned int theDesktopIndex)
{
    ...
    {
        // Karttan�yt�ill� on omat aktiivisten rivien muistit, joten k�ytet��n niit�
        absoluteActiveRow = itsSmartMetDocumentInterface->MapViewDescTop(theDesktopIndex)->AbsoluteActiveViewRow();
    }
    else
    {
        //  Muille n�yt�ille ParameterSelectionSystem saa toimia aktiivisten rivien muistina
