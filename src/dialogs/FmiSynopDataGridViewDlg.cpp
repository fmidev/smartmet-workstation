...
// Pˆllitty verkosta Matt Austernilta.
...
void CFmiSynopDataGridViewDlg::InitForecastSynopHeaders(void)
{
	...
	itsForecastSynopHeaders.push_back(HeaderParInfo(kFmiWeatherSymbol1, "ww", false, basicColumnWidthUnit*2)); // t‰ss‰ haetaan hsade1 ww tilalle
...
void CFmiSynopDataGridViewDlg::InitMinMaxDataHeaders(void)
{
	...
	itsMinMaxDataHeaders.push_back(HeaderParInfo(kFmiBadParameter, timeStr, false, static_cast<int>(basicColumnWidthUnit*2.3), HeaderParInfo::kDateAndTime));
	itsMinMaxDataHeaders.push_back(HeaderParInfo(kFmiPresentWeather, "wwmax", false, basicColumnWidthUnit*2, HeaderParInfo::kMax)); // t‰ss‰ haetaan hsade1 ww tilalle
	itsMinMaxDataHeaders.push_back(HeaderParInfo(kFmiBadParameter, timeStr, false, static_cast<int>(basicColumnWidthUnit*2.3), HeaderParInfo::kDateAndTime));
...
void CFmiSynopDataGridViewDlg::InitForecastMinMaxDataHeaders(void)
{
	...
	itsForecastMinMaxDataHeaders.push_back(HeaderParInfo(kFmiBadParameter, timeStr, false, static_cast<int>(basicColumnWidthUnit*2.3), HeaderParInfo::kDateAndTime));
	itsForecastMinMaxDataHeaders.push_back(HeaderParInfo(kFmiWeatherSymbol1, "wwmax", false, basicColumnWidthUnit*2, HeaderParInfo::kMax)); // t‰ss‰ haetaan hsade1 ww tilalle
	itsForecastMinMaxDataHeaders.push_back(HeaderParInfo(kFmiBadParameter, timeStr, false, static_cast<int>(basicColumnWidthUnit*2.3), HeaderParInfo::kDateAndTime));
...
{
    itsSmartMetDocumentInterface->SynopDataGridViewOn(theViewMacro.ShowWindow()); // t‰m‰kin on asetettava, arvo saatiin CZeditmap2Doc-luokassa tutkimalla ikkunan tilaa
