...
$Version = "5.13.22.1"
$DistributionFolder = "MetEditor_5_13_22_1"
# Laita t‰h‰n koneessa olevan Dropbox hakemiston asemakirjain, mihin kaikki 
# shortcutit talletetaan kuitenkin Dropboxin ulkopuolelle.
$CurrentDropboxDriveLetter = "D"

# BaseFolder on perushakemisto ilman asemakirjainta
$BaseFolder = ":\SmartMet"
# Dropbox halusi muuttaa peruskansion nimess‰ yhtiˆn nimen alkuun
$CompanyNameDropboxFolder = "FMI Dropbox"
# Dropbox halusi lis‰t‰ k‰ytt‰j‰n nimen hakemistorakenteeseen jostain syyst‰.
#$DropboxUserNameFolder = "Marko Pietarinen"
$DropboxUserNameFolder = "FMI Meteorologit"
# Dropboxissa oleva perus smartmet kansio.
$SmartMetFolder = "$BaseFolder\$CompanyNameDropboxFolder\$DropboxUserNameFolder\SmartMet"
