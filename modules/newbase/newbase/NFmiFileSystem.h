...
// Filename completion
 const std::string FileComplete(const std::string &theFile,
...
std::time_t FindFile(const std::string &theFileFilter,
 ...
 std::time_t NewestFileTime(const std::list<std::string> &theFileList,
                                    const std::string &thePath);
 std::string NewestFileName(const std::list<std::string> &theFileList,
                                    const std::string &thePath);
