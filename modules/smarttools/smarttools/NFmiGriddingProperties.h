...
class NFmiGriddingProperties
{
    ...
    // I don't know the unit, but the default is 0.5 and I don't understand it.
...
public:
    ...
    void localFitFilterRadius(double localFitFilterRadius) { localFitFilterRadius_ = localFitFilterRadius; }
    double localFitFilterFactor() const { return  localFitFilterFactor_; }
    void localFitFilterFactor(double localFitFilterFactor) { localFitFilterFactor_ = localFitFilterFactor; }
